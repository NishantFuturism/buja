                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-10" id="my-account-reorder">
                              ...
                              <div id="last_purchaseddiv">
                                ...
                                <div className='shopping-cart-wrapper '>
                                    ...
                                    {reorderlist && reorderlist.GetSku.length > 0 ? 
                                    <table className="table table-bordered reorderonmob" id="last_Purchased"><thead>
                                      <tr>
                                        <th>Product Image</th>
                                        <th
                                    ...
                                    <table className="table table-bordered reorderonmob" id="last_Purchased">
                                      ...
                                      :
                                      <table className="table table-bordered reorderonmob" id="last_Purchased"><tbody>
