...
import { SaveCartList } from '../saveCartListing';
...
import { applyCoupon, closeMsgBar, getCartData, getCouponList, removeCoupon, removeFromCart } from './actions';
import Item from './Item';
import reducer from './reducer';
import saga from './saga';
import './viewcartStyle.css';
...
export function ViewCart() {
  ...
  const loadcheckout = () => {
    if ((localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined)) {
      ...
      history.push('/productprocced/checkout', { total: cartAllData !== undefined && (cartAllData.total) })
    }
  }
  ...
  return (
    <>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div className="col-12 col-sm-12 col-md-12">
                      <div className="section-title text-center">
                        <p align="center" style={{ padding: '10px 0px' }}>
                          <Link to="/">
                            <img referrerPolicy='no-referrer' alt="brand-logo" src={brandlogo} width="198px" height="45px" style={{ paddingLeft: "23px" }} />
                          </Link>
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="row">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                          <main id="primary" className="site-main">
                                  ...
                                  {cartAllData !== undefined && cartAllData.cart !== undefined &&
                                    ...
                                    (<div className="col-12 col-sm-12 col-md-12 col-lg-12">
                                      ...
                                      <div className="cart-button-wrapper" id='viewcarttextright1'>
                                        ...
                                        <Link id="continueshoppingbtn" to="/" className="btn btn-secondary empty-cart">Continue Shopping</Link>
                                        {
                                              ...
                                              {cartAllData.freetotalamount > 0 && (
                                                <div className="col-sm-4 col-md-6 col-lg-12 cartlisttab">
                                                  <span>
                                                    ...
                                                    <Link to="/delivery-policy"> Our delivery charge details page matrix</Link>
                                                  </span>
                                                </div>
                                              )}
                                            </div>
                            ...
                            {(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? null : <SaveCartList />}
                            {/* (localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? null : <ReorderProduct /> */}
                            {(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? null : <WishlistPaged />}
              ...
              {/* {localStorage.getItem('CustGUID') === null ? null :
      ...
      {/* {localStorage.getItem('CustGUID') === null && nextData && nextData.dealData && nextData.dealData.Data === null ? null :
