...
import { ADD_TO_CART_SUCCESS, CLOSE_MSG_BAR, DEFAULT_ACTION, NEXT_PAGE_SUCCESS, RESPONCE_MSG, SHOPPING_CART_DETAILS_RELETED } from './constants';
  ...
  produce(state, draft => {
    switch (action.type) {
      ...
      case NEXT_PAGE_SUCCESS:
        ...
        break;
      case SHOPPING_CART_DETAILS_RELETED:
        draft.shoppingDetailsReleted = action.shoppingcartDetails
        break;
    }
  });
