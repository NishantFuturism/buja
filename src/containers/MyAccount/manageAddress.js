                            ...
                            <div id="address_list" className="row address-view">
                              ...
                              {enableaddressformn ?
                                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 addr_form" style={{ display: 'block' }}>
                                  ...
                                  <AddressForm
                                    editdata1={editdata} cancelform={cancelform} atosuggestdadta={atosuggestdadta} userdetail={userdetail} fetchaddress={fetchaddress} edit={edit} Pin={pin} editdata={userdetail} Address={locationname || searchaddress} AddressTypeName={customeraddress} />
                                </div>
                                : null
                              }
                            </div>
